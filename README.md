...
[![Open issues, all kinds](https://img.shields.io/github/issues/simonmichael/hledger.svg "Open issues, all kinds.")](https://github.com/hledgerorg/hledger/issues?q=is:issue+state:open)
[![Open bugs](https://api.gitscope.dev/api/badges/simonmichael/hledger/label/A-BUG.svg "Open bugs")](https://github.com/hledgerorg/hledger/issues?q=is:issue+label:A-BUG+state:open) 
[![Open wishes](https://api.gitscope.dev/api/badges/simonmichael/hledger/label/A-WISH.svg "Open wishes")](https://github.com/hledgerorg/hledger/issues?q=is:issue+label:A-WISH+state:open)
[![Issues Resolved](https://api.gitscope.dev/api/badges/simonmichael/hledger/resolved.svg "Percentage of issues resolved/closed during last N days. Higher is better. Click to see closed bugs.")](https://github.com/hledgerorg/hledger/issues?q=is:issue+state:closed)
-->
