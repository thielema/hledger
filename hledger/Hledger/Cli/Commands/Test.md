...
You can use this as a sanity-check of the hledger executable installed on your system.
A failure is unlikely, since these and other much larger test suites run frequently during hledger development -
but if you see one, please report it as a bug!
