...
with related code and data files in [hledger/bench/](https://github.com/hledgerorg/hledger/tree/main/hledger/bench).
...
then runs [hledger/bench/bench.hs](https://github.com/hledgerorg/hledger/blob/main/hledger/bench/bench.hs),
...
`--simplebench` shows a table of elapsed-time measurements for the commands defined in [bench/default.bench](https://github.com/hledgerorg/hledger/blob/main/hledger/bench/default.bench).
...
bench's --simplebench mode is based on a standalone tool, [tools/simplebench.hs](https://github.com/hledgerorg/hledger/blob/main/tools/simplebench.hs).
...
[dev.hs](https://github.com/hledgerorg/hledger/blob/main/dev.hs).
