...
[tag](#tags-1) (see below) like `date:DATE`.  This is probably the best
...
They will look like normal transactions, but with some extra [tags](manual.html#tags-1):
 
- `recur:PERIODICEXPR`      - shows which periodic expression generated this, and when the next occurrence is likely to be 
- `generated-transaction:`  - shows that this was generated by a periodic transaction rule 
- `_generated-transaction:` - a hidden tag which can be matched, but does not appear in the comment or print's output.
                              So if you save generated transactions to the journal, this tag can be used
                              to more reliably match transactions generated "just now" rather than  
                              transactions that were generated and saved in the past.
...
They will have some extra [tag](#tags-1):  

- `generated-posting:`  - shows this was generated by a transaction modifier rule 
- `_generated-posting:` - a hidden tag which can be matched, but does not appear in the comment or print's output.
                          So if you save modified transactions to the journal, this tag can be used
                          to more reliably match postings generated "just now" rather than  
                          postings that were generated and saved in the past.
