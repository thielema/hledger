...
- Ledger directives which hledger ignores are dropped.
- Transactions generated by `--forecast`, and postings generated by `--auto` or `--infer-equity`, are not shown.
...
- Only the default (txt) output format is supported, currently. (Ie, this exports a hledger-readable journal.)
